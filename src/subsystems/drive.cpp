...
namespace auton
{
    void skills()
    {
        ...
        roller_on();
        // pid::turnPID(38);
        pid::drivePID(800); // originally 1200
        frontLift_up(true);
        // pid::drivePID(-70);
        //  pid::turnPID(90);
        // backLift_down();
...
//============= place goal on platform =============
        ...
        pid::turnPID(180, 1.5, 5.0);
        // pid::delaySeconds(0.4);
        pid::drivePID(-2100);
        backLift_up();
        pid::delaySeconds(0.5);

        pid::turnPID(-90, 1.5, 5.0);
    ...
    {
        double angle = 265.0;
        while (rotation.get() > angle + 1 || rotation.get() < angle - 1)
        {
